void _Randomx_context_chunk_pack_s1_impl(
  std::string*& err,
  ...
  _this->tmpEntropy = randomx_calculate_hash_long_with_entropy_get_entropy(_this->vm_ptr, (const u8*)pack_key, pack_key_len, packing_iter);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_context_chunk_pack_s1_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(4)
  ...
  _Randomx_context_chunk_pack_s1_impl(err, _this, pack_key, pack_key_len, chunk_i, chunk_i_len, chunk_o, chunk_o_len, packing_iter);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_context_chunk_pack_s1 {
  Randomx_context* _this;
  u8* pack_key;
  size_t pack_key_len;
...
void _worker_ctx_Randomx_context_chunk_pack_s1_clear(napi_env env, struct Worker_ctx_Randomx_context_chunk_pack_s1* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_context_chunk_pack_s1(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_context_chunk_pack_s1* worker_ctx = (struct Worker_ctx_Randomx_context_chunk_pack_s1*)_data;
  _Randomx_context_chunk_pack_s1_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->pack_key, worker_ctx->pack_key_len, worker_ctx->chunk_i, worker_ctx->chunk_i_len, worker_ctx->chunk_o, worker_ctx->chunk_o_len, worker_ctx->packing_iter);
}

void _complete_Randomx_context_chunk_pack_s1(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_context_chunk_pack_s1* worker_ctx = (struct Worker_ctx_Randomx_context_chunk_pack_s1*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_context_chunk_pack_s1_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_context_chunk_pack_s1(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(5)
  FN_ARG_THIS(Randomx_context)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_context_chunk_pack_s1* worker_ctx = new Worker_ctx_Randomx_context_chunk_pack_s1;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Randomx_context_chunk_pack_s1,
    _complete_Randomx_context_chunk_pack_s1,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
