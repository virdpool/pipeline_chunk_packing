void _Randomx_pipeline_node_ep_o_impl(
  std::string*& err,
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_node_ep_o_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  ...
  _Randomx_pipeline_node_ep_o_impl(err, _this, ring_size);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_node_ep_o {
  Randomx_pipeline_node* _this;
  u32 ring_size;
...
void _worker_ctx_Randomx_pipeline_node_ep_o_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_node_ep_o* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_node_ep_o(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_node_ep_o* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_ep_o*)_data;
  _Randomx_pipeline_node_ep_o_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->ring_size);
}

void _complete_Randomx_pipeline_node_ep_o(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_node_ep_o* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_ep_o*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_node_ep_o_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_node_ep_o(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(2)
  FN_ARG_THIS(Randomx_pipeline_node)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  FN_ARG_U32(ring_size)
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_node_ep_o* worker_ctx = new Worker_ctx_Randomx_pipeline_node_ep_o;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_node_ep_o,
    _complete_Randomx_pipeline_node_ep_o,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
