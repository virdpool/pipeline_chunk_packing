void _Randomx_pipeline_node_fn_set_impl(
  std::string*& err,
  Randomx_pipeline_node* _this,
  u32          fn_index
) {
  if (fn_index-1 >= randomx_pipeline_global_registry_fn_list.size()) {
  ...
  _this->fn = randomx_pipeline_global_registry_fn_list[fn_index-1];
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_node_fn_set_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  ...
  _Randomx_pipeline_node_fn_set_impl(err, _this, fn_index);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_node_fn_set {
  Randomx_pipeline_node* _this;
  u32 fn_index;
...
void _worker_ctx_Randomx_pipeline_node_fn_set_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_node_fn_set* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_node_fn_set(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_node_fn_set* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_fn_set*)_data;
  _Randomx_pipeline_node_fn_set_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->fn_index);
}

void _complete_Randomx_pipeline_node_fn_set(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_node_fn_set* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_fn_set*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_node_fn_set_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_node_fn_set(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(2)
  FN_ARG_THIS(Randomx_pipeline_node)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  FN_ARG_U32(fn_index)
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_node_fn_set* worker_ctx = new Worker_ctx_Randomx_pipeline_node_fn_set;
  worker_ctx->err = nullptr;
  ...
  worker_ctx->fn_index = fn_index;
  
  status = napi_create_async_work(
    env,
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_node_fn_set,
    _complete_Randomx_pipeline_node_fn_set,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
