void _Randomx_pipeline_node_task_pull_count_impl(
  std::string*& err,
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_node_task_pull_count_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD_EMPTY
  ...
  u32 ret;
  _Randomx_pipeline_node_task_pull_count_impl(err, _this, ret);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_node_task_pull_count {
  Randomx_pipeline_node* _this;
  u32 ret;
...
void _worker_ctx_Randomx_pipeline_node_task_pull_count_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_node_task_pull_count* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_node_task_pull_count(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_node_task_pull_count* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_task_pull_count*)_data;
  _Randomx_pipeline_node_task_pull_count_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->ret);
}

void _complete_Randomx_pipeline_node_task_pull_count(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_node_task_pull_count* worker_ctx = (struct Worker_ctx_Randomx_pipeline_node_task_pull_count*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_node_task_pull_count_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_node_task_pull_count(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  FN_ARG_THIS(Randomx_pipeline_node)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_node_task_pull_count* worker_ctx = new Worker_ctx_Randomx_pipeline_node_task_pull_count;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_node_task_pull_count,
    _complete_Randomx_pipeline_node_task_pull_count,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
