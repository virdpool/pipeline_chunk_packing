void _Randomx_pipeline_thread_cpu_core_id_set_impl(
  std::string*& err,
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_thread_cpu_core_id_set_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  FN_ARG_THIS(Randomx_pipeline_thread)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  FN_ARG_U32(cpu_core_id)
  
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  std::string *err = nullptr;
  _Randomx_pipeline_thread_cpu_core_id_set_impl(err, _this, cpu_core_id);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set {
  Randomx_pipeline_thread* _this;
  u32 cpu_core_id;
...
void _worker_ctx_Randomx_pipeline_thread_cpu_core_id_set_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_thread_cpu_core_id_set(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set*)_data;
  _Randomx_pipeline_thread_cpu_core_id_set_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->cpu_core_id);
}

void _complete_Randomx_pipeline_thread_cpu_core_id_set(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_thread_cpu_core_id_set_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_thread_cpu_core_id_set(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(2)
  FN_ARG_THIS(Randomx_pipeline_thread)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  FN_ARG_U32(cpu_core_id)
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set* worker_ctx = new Worker_ctx_Randomx_pipeline_thread_cpu_core_id_set;
  worker_ctx->err = nullptr;
  ...
  worker_ctx->cpu_core_id = cpu_core_id;
  
  status = napi_create_async_work(
    env,
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_thread_cpu_core_id_set,
    _complete_Randomx_pipeline_thread_cpu_core_id_set,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
