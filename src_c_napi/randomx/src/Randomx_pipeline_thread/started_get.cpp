void _Randomx_pipeline_thread_started_get_impl(
  std::string*& err,
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_thread_started_get_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD_EMPTY
  ...
  bool ret;
  _Randomx_pipeline_thread_started_get_impl(err, _this, ret);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_thread_started_get {
  Randomx_pipeline_thread* _this;
  bool ret;
...
void _worker_ctx_Randomx_pipeline_thread_started_get_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_thread_started_get* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_thread_started_get(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_thread_started_get* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_started_get*)_data;
  _Randomx_pipeline_thread_started_get_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->ret);
}

void _complete_Randomx_pipeline_thread_started_get(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_thread_started_get* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_started_get*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_thread_started_get_clear(env, worker_ctx);
    return;
  }
  ...
  status = napi_get_boolean(env, worker_ctx->ret, &call_argv[1]);
  if (status != napi_ok) {
    fprintf(stderr, "status = %d\n", status);
    napi_throw_error(env, nullptr, "napi_get_boolean FAIL");
    _worker_ctx_Randomx_pipeline_thread_started_get_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_thread_started_get(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  FN_ARG_THIS(Randomx_pipeline_thread)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_thread_started_get* worker_ctx = new Worker_ctx_Randomx_pipeline_thread_started_get;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_thread_started_get,
    _complete_Randomx_pipeline_thread_started_get,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
