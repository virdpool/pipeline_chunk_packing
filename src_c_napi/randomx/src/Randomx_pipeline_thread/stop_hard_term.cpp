void _Randomx_pipeline_thread_stop_hard_term_impl(
  std::string*& err,
...
//   sync
////////////////////////////////////////////////////////////////////////////////////////////////////
napi_value Randomx_pipeline_thread_stop_hard_term_sync(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD_EMPTY
  ...
  _Randomx_pipeline_thread_stop_hard_term_impl(err, _this);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term {
  Randomx_pipeline_thread* _this;
...
void _worker_ctx_Randomx_pipeline_thread_stop_hard_term_clear(napi_env env, struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Randomx_pipeline_thread_stop_hard_term(napi_env env, void* _data) {
  struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term*)_data;
  _Randomx_pipeline_thread_stop_hard_term_impl(worker_ctx->err, worker_ctx->_this);
}

void _complete_Randomx_pipeline_thread_stop_hard_term(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term* worker_ctx = (struct Worker_ctx_Randomx_pipeline_thread_stop_hard_term*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Randomx_pipeline_thread_stop_hard_term_clear(env, worker_ctx);
    return;
  }
...
napi_value Randomx_pipeline_thread_stop_hard_term(napi_env env, napi_callback_info info) {
  FN_ARG_HEAD(1)
  FN_ARG_THIS(Randomx_pipeline_thread)
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Randomx_pipeline_thread_stop_hard_term* worker_ctx = new Worker_ctx_Randomx_pipeline_thread_stop_hard_term;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Randomx_pipeline_thread_stop_hard_term,
    _complete_Randomx_pipeline_thread_stop_hard_term,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
